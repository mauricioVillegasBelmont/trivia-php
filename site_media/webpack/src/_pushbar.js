export class Pushbar {
  constructor(e = {
    ...
    this.bindEvents()
    setTimeout(function(){
      const e = document.querySelector(`[data-pushbar-id]`);
      e && e.classList.remove("pushbar_hidden");
    },520);
  }
  emitOpening() {
  ...
  bindEvents() {
    ...
    e.forEach(e => e.addEventListener("click", e => this.handleOpenEvent(e), !1)),
    t.forEach(e => e.addEventListener("click", e => this.handleCloseEvent(e), !1)),
    this.overlayElement && this.overlayElement.addEventListener("click", e => this.handleCloseEvent(e), !1),
